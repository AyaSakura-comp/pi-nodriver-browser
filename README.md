...
- Serializes daemon commands while preserving independent active pages for concurrent Pi sessions
...
- The daemon serializes commands across all connected Pi extension instances and routes each command by Pi session ID.
